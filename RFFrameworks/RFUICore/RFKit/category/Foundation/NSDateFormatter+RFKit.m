...
+ (NSString *)formatDateString:(NSString *)dateString {
    dateString = [[dateString stringByReplacingOccurrencesOfString:@"T" withString:@" "]stringByReplacingOccurrencesOfString:@"+" withString:@" "];
    NSString *str = [NSString stringWithFormat:@"%@ %@",[dateString componentsSeparatedByString:@" "][0],[dateString componentsSeparatedByString:@" "][1]];
    return str;
}
