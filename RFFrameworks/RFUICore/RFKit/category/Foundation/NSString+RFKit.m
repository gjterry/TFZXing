...
- (CGFloat)heightOfTextWithFont:(UIFont *)font
                 MaxLen:(float )maxLen {
    CGSize size = [self sizeWithFont:font constrainedToSize:CGSizeMake(maxLen, CGFLOAT_MAX) lineBreakMode:NSLineBreakByCharWrapping];
    return size.height;
}
