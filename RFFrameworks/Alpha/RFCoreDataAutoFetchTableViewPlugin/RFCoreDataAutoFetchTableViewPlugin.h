...
- (BOOL)RFCoreDataAutoFetchTableViewPlugin:(RFCoreDataAutoFetchTableViewPlugin *)plugin shouldCloseSectionInSection:(NSInteger)section;


- (NSManagedObject *)RFCoreDataAutoFetchTablePlugin:(RFCoreDataAutoFetchTableViewPlugin *)plugin canAddManagedObject:(NSManagedObject *)managedObject;

- (NSMutableArray *)RFCoreDataAutoFetchTablePlugin:(RFCoreDataAutoFetchTableViewPlugin *)plugin  sortingSource:(NSMutableArray *)source;
@end
...
@property (nonatomic, assign) BOOL  fetchedDataInCustomMode;
